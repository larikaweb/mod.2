...
rows = int(input('Укажите число строк в матрице: '))
cols = int(input('Укажите число столбцов в матрице: '))
valuem = int(input('Укажите значние для матрицы: '))
...
# Вывод матрицы по заданным данным
result1 = get_matrix(2, 2, 10)
result2 = get_matrix(3, 5, 42)
result3 = get_matrix(4, 2, 13)
print('Вывод матрицы по заданным данным: ')
print(result1)
print(result2)
print(result3)

# Вывод матрицы по запрашиваемым данным
print('Вывод матрицы по запрашиваемым данным: ')
result_n = get_matrix(rows, cols, valuem)
print(result_n)